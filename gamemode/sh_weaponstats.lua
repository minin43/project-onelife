...
if weapons.Get( "cw_kk_ins2_toz" ) then
    local wep = weapons.GetStored( "cw_kk_ins2_toz" )
	--wep.PrintName = ""
    wep.SpeedDec = 15 --Gun Weight
    wep.Slot = 3 --The weapon slot to be used
    --wep.FireModes = {"auto", "semi"} --Available firing types
    wep.Primary.ClipSize = 6 --Weapon clip size
    wep.Primary.DefaultClip	= 7 --Initial clip clip size
    --wep.Primary.Ammo = "" --The ammo type the weapon uses
    wep.FireDelay = 0.3 --Fire rate
    ...
    wep.ClumpSpread = .043 --The pellet spread, or pellet clump size
    wep.SpreadPerShot = 0.01 --spread increase per bullet
    wep.SpeadCooldown = wep.FireDelay + 0.05 --Length in seconds before the spread reset
    wep.Shots = 18 --How many shots come out of the gun when fired (not ammo consumption)
    wep.Damage = 9 --Damage
    --wep.ReloadTimes[ base_reload ] = { 0, 0 } --Time acceleration, time in seconds when ammo is in the clip
    --wep.ReloadTimes[ base_reloadempty ] = { 0, 0 } --Time acceleration, time in seconds with an empty magazine
end
...
if weapons.Get( "cw_kk_ins2_m590" ) then
    ...
    wep.VelocitySensitivity = 1.9 --spread increase when whipping your gun around
    wep.MaxSpreadInc = 0.06 --Maximum spread your weapon can achieve
    wep.ClumpSpread = .033 --The pellet spread, or pellet clump size
    wep.SpreadPerShot = 0.01 --spread increase per bullet
    wep.SpeadCooldown = wep.FireDelay + 0.05 --Length in seconds before the spread reset
    wep.Shots = 11 --How many shots come out of the gun when fired (not ammo consumption)
    wep.Damage = 10 --Damage
    --wep.ReloadTimes[ base_reload ] = { 0, 0 } --Time acceleration, time in seconds when ammo is in the clip
    --wep.ReloadTimes[ base_reloadempty ] = { 0, 0 } --Time acceleration, time in seconds with an empty magazine
end
